          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {steps.map((step) => (
              <div key={step.number} className="relative">
                <div className="h-12 w-12 rounded-md bg-primary-600 flex items-center justify-center text-white text-xl font-bold">
                  {step.number}
                </div>
                <h3 className="mt-6 text-lg font-display font-medium text-gray-900">{step.title}</h3>
